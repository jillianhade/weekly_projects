...
The first part of assignment will be focused on scraping [Indeed.com](https://www.indeed.com) and the second will be focused on using the listings with salary information to build a model and predict salaries.
